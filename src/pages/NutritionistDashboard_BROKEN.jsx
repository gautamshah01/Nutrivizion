...
import {
  Calendar, Users, DollarSign, MessageCircle, Star, TrendingUp, Clock, Video, Phone,
...
const NutritionistDashboard = () => {
  ...
  const handleAppointmentAction = async (appointmentId, action) => {
    try {
      ...
      await api.put(`/nutritionist/appointments/${appointmentId}`, updateData)
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white shadow rounded-lg">
              ...
              <div className="p-6">
                ...
                <button className="w-full mt-4 text-sm text-primary-600 hover:text-primary-800">
                  View All Messages
                </button>
              </div>
            </div>
            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-6 py-4 border-b border-gray-200">
                <h3 className="text-lg font-medium text-gray-900">Earnings & Payments</h3>
              </div>
              <div className="p-6">
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium text-green-600">
                      ${dashboardData.earnings.pendingPayout.toLocaleString()}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Sessions This Month</span>
                    <span className="text-sm font-medium text-gray-900">
                      {dashboardData.earnings.completedSessions}
                    </span>
                  </div>
                </div>
                <button className="w-full mt-4 text-sm text-primary-600 hover:text-primary-800">
